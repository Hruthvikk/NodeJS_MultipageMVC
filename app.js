...
app.use(function(req,res,next) {
        ...
        var l =new Date()+","+req.path+","+req.ip+","+JSON.stringify(req.query)+","+JSON.stringify(req.body)+"\r\n";
        
        wf.appendFileSync('log.txt',l); 
  ...
  req.TPL.displaySignedup = req.session.sumess;
...
app.use("/editors/delete", require("./controllers/editors"));
